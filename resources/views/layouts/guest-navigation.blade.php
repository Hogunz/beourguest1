                ...
                <nav class="  bg-transparent border-gray-200 px-2 md:px-4 py-2.5 dark:bg-gray-900">
                    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="/" class="flex items-center">
                            ...
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white bg-gradient-to-br from-blue-500 via-orange-500 to-yellow-600 bg-clip-text text-transparent" style="font-family: 'Welth Catritz Free Personal Use', sans-serif;">Be our guest</span>
                        </a>
